...
<div class="gif-bajodcha">
  <img src="img/eliminar.png" alt="Imagen">
</div>
...
if ($come!="") {$micome='. '.'<i><font color="darkgray" size="2px">'.$come.'</font></i>';}
      echo '<a href="eliminalabase.php?mtk='.$_SESSION["elusuario"]."/".'bases/'.$archives[$cuenteo].'"  onclick="return confirmar();">'.$kikio1[0].$micome.'</a>';
      echo '<br><br>';
       $cuenteo++;
 }
...
include($_SESSION["elusuario"]."/"."backup/".$kikio1[0].".php");

if ($come!="") {$micome='. '.'<i><font color="darkgray" size="2px">'.$come.'</font></i>';}
      echo '<a href="borralabase.php?mtk='.$_SESSION["elusuario"]."/".'backup/'.$archives[$cuenteo].'" title="Eliminar la base de datos" onclick="return confirmar1();"><img src="eliminabase.png" width="20px"></a>   ';
      echo '<a href="recuperalabase.php?mtk='.$_SESSION["elusuario"]."/".'backup/'.$archives[$cuenteo].'" title="Recuperar la base de datos">'.$kikio1[0].$micome.'</a>';
      echo '<br><br>';
       $cuenteo++;
 }
...
<br>
<table width='100%' border='0' bgcolor="#f98ac5">
...
<br><br><br>
<table width='100%' border='0' bgcolor="#D0CFCF">
<tr><td align='left' width="10%">
<a href="inicio.php"><img src="volver.png" width="30px"></a>
</td><td align='center'>
<?php echo "PAPELERA";?>
...
$cuantosarchivos=0;
$archives[]="";
$dir = opendir($_SESSION["elusuario"]."/"."backup");
  while ($elemento = readdir($dir)){
      if( $elemento != "." && $elemento != ".." && strpos($elemento,".csv")){
          if( is_dir($_SESSION["elusuario"]."/"."backup".$elemento) ){
          } else {
            $archives[$cuantosarchivos]=$elemento;
            $cuantosarchivos++;
          }
...
listarArchivosbk( $_SESSION["elusuario"]."/"."backup",$cuantosarchivos,$archives ); 
