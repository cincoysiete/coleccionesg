...
echo '     <a href="grafica.php?qwer='.$_GET["qwer"].'&nomcol='.$_GET["nomcol"].'" title="Toca para ver gráfica de barras"><img src="barra-grafica.png" width="25px"></a>';
echo '     <a href="graficaline.php?qwer='.$_GET["qwer"].'&nomcol='.$_GET["nomcol"].'" title="Toca para ver gráfica de líneas"><img src="grafico-de-lineas.png" width="25px"></a>';
echo '     <a href="graficapie.php?qwer='.$_GET["qwer"].'&nomcol='.$_GET["nomcol"].'" title="Toca para ver gráfica de pastel"><img src="grafico-de-torta.png" width="25px"></a>';
...
// if (trim($datos[$_SESSION["columna"]])==$_SESSION["filtro"] ){
    $plato = trim($datos[$_GET["qwer1"]]); // La tercera columna es el nombre del plato
    if (isset($platos[$plato])) {
        $platos[$plato]++;
        if ($_GET["qwer1"]!=$_GET["qwer2"]){$coste[$plato]=$coste[$plato]+$datos[$_GET["qwer2"]];}
    } else {
        $platos[$plato] = 1;
        if ($_GET["qwer1"]!=$_GET["qwer2"]){$coste[$plato]=$coste[$plato]+$datos[$_GET["qwer2"]];}
    }
